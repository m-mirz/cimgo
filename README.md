...
a Go `Check<...>` function under `shaclgen/`. The ~200 SPARQL constraints are 
not generated by `cmd/shaclgen` but instead implemented as hand-written Go functions.

Across 74 TTL SHACL files there are ~1000 constraints total. Half of these generate
...
or cannot be conducted due to upstream SHACL TTL defects.
...
### Structurally satisfied (3199 skips)
