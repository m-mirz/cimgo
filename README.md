...
Across all profiles, there are approximately **200** SPARQL-based constraints. Of these, **115** are currently implemented, with a focus on core Equipment and SSH profiles.

| Profile Group | SPARQL Constraints | Implemented | Coverage |
|---------------|-------------------:|------------:|---------:|
| Equipment (EQ) | 69 | 64 | 93% |
| Steady State Hypothesis (SSH) | 40 | 22 | 55% |
| Dynamics (DY) | 40 | 3 | 8% |
| State Variables (SV) | 11 | 7 | 64% |
| Short Circuit (SC) | 7 | 5 | 71% |
| Others (TP, DL, All, etc.) | 32 | 14 | 44% |
| **Total** | **199** | **115** | **58%** |
