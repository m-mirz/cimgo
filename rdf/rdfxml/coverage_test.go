...
<ex:Person xmlns:ex="http://example.org/"
	...
	person := term.NewURIRefUnsafe("http://example.org/Person")
	if !g.Contains(alice, namespace.RDF.Type, person) {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	items := term.NewURIRefUnsafe("http://example.org/items")
	if !g.Contains(s, items, namespace.RDF.Nil) {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	if !g.Contains(o, namespace.RDF.Type, person) {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	dcTitle := term.NewURIRefUnsafe("http://purl.org/dc/elements/1.1/title")
	found := false
	g.Triples(nil, &dcTitle, nil)(func(t term.Triple) bool {
		if lit, ok := t.Object.(term.Literal); ok && lit.Lexical() == "Editor" {
			found = true
		}
		return true
	})
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	html := term.NewURIRefUnsafe("http://example.org/html")
	val, ok := g.Value(s, &html, nil)
	if !ok {
		t.Fatal("expected value")
	}
	lit, ok := val.(term.Literal)
	if !ok {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	content := term.NewURIRefUnsafe("http://example.org/content")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	note := term.NewURIRefUnsafe("http://example.org/note")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	code := term.NewURIRefUnsafe("http://example.org/code")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	outer := term.NewURIRefUnsafe("http://example.org/outer")
...
func TestSerializeBNodeSubject(t *testing.T) {
	...
	bn := term.NewBNode("x1")
	g.Add(bn, term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("Bob"))
...
func TestSerializeLangTagLiteral(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/label"),
		term.NewLiteral("Hallo", term.WithLang("de")))
...
func TestSerializeTypedLiteral(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/age"),
...
func TestSerializePlainLiteral(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/note"),
...
func TestSerializeURIRefObject(t *testing.T) {
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	o := term.NewURIRefUnsafe("http://example.org/o")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/link"), o)
...
func TestSerializeBNodeObject(t *testing.T) {
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	bn := term.NewBNode("y2")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/ref"), bn)
...
func TestSerializeWithBase(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
...
func TestSerializeRoundtripLangLiteral(t *testing.T) {
	g1 := graph.NewGraph()
	g1.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g1.Add(s, term.NewURIRefUnsafe("http://example.org/label"),
		term.NewLiteral("Hola", term.WithLang("es")))
...
func TestSerializeRoundtripTypedLiteral(t *testing.T) {
	...
	g1.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g1.Add(s, term.NewURIRefUnsafe("http://example.org/count"),
		term.NewLiteral("7", term.WithDatatype(term.XSDInteger)))
	...
	count := term.NewURIRefUnsafe("http://example.org/count")
	val, ok := g2.Value(s, &count, nil)
	if !ok {
		t.Fatal("expected count triple after roundtrip")
	}
	lit, ok := val.(term.Literal)
	if !ok || lit.Datatype() != term.XSDInteger {
...
func TestSerializeMultipleRDFType(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	t1 := term.NewURIRefUnsafe("http://example.org/Type1")
	t2 := term.NewURIRefUnsafe("http://example.org/Type2")
	g.Add(s, namespace.RDF.Type, t1)
	g.Add(s, namespace.RDF.Type, t2)
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("val"))
...
func TestSerializeNoQNamePredicate(t *testing.T) {
	g := graph.NewGraph()
	s := term.NewURIRefUnsafe("http://example.org/s")
	p := term.NewURIRefUnsafe("http://example.org/no-namespace-match/p")
...
func TestSerializeRDFTypeNoQName(t *testing.T) {
	...
	noNSType := term.NewURIRefUnsafe("http://no-ns-registered.org/MyType")
	g.Add(s, namespace.RDF.Type, noNSType)
...
func TestSerializeDirLangLiteral(t *testing.T) {
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/label"),
		term.NewLiteral("مرحبا", term.WithLang("ar"), term.WithDir("rtl")))
	var buf bytes.Buffer
	if err := Serialize(g, &buf); err != nil {
		t.Fatal(err)
	}
...
func TestSerializeMultipleTypesWithSecondNoQName(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, namespace.RDF.Type, term.NewURIRefUnsafe("http://example.org/Type1"))
	g.Add(s, namespace.RDF.Type, term.NewURIRefUnsafe("http://no-ns.org/Type2"))
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	var buf bytes.Buffer
	if err := Serialize(g, &buf); err != nil {
		t.Fatal(err)
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	agePred := term.NewURIRefUnsafe("http://example.org/age")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	p := term.NewURIRefUnsafe("http://example.org/p")
	o := term.NewURIRefUnsafe("http://other.org/thing")
	if !g.Contains(s, p, o) {
...
func TestSerializeTripleTermObject(t *testing.T) {
	...
	inner := term.NewTripleTerm(
		term.NewURIRefUnsafe("http://example.org/a"),
		term.NewURIRefUnsafe("http://example.org/b"),
		term.NewURIRefUnsafe("http://example.org/c"),
	)
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), inner)
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s"
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	person := term.NewURIRefUnsafe("http://example.org/Person")
	if !g.Contains(s, namespace.RDF.Type, person) {
...
func TestSerializeWriteErrorOnNamespace(t *testing.T) {
	g := graph.NewGraph()
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	g.Bind("foaf", term.NewURIRefUnsafe("http://xmlns.com/foaf/0.1/"))
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
...
func TestSerializeWriteErrorOnSubject(t *testing.T) {
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	g.Add(s, term.NewURIRefUnsafe("http://example.org/q"),
		term.NewURIRefUnsafe("http://example.org/o"))
