...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <ex:Person rdf:about="http://example.org/Alice">
	...
	alice, _ := term.NewURIRef("http://example.org/Alice")
	person, _ := term.NewURIRef("http://example.org/Person")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	knows, _ := term.NewURIRef("http://example.org/knows")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	if lit, ok := val.(term.Literal); !ok || lit.Language() != "en" {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	if lit, ok := val.(term.Literal); !ok || lit.Datatype() != term.XSDInteger {
...
func TestRDFXMLSerializerTypedNode(t *testing.T) {
	...
	g.Add(s, term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("Alice"))
...
func TestRDFXMLRoundtrip(t *testing.T) {
	...
	g1.Add(s, p, term.NewLiteral("world", term.WithLang("en")))
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="http://example.org/s">
	...
	s, _ := term.NewURIRef("http://example.org/s")
	content, _ := term.NewURIRef("http://example.org/content")
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="s2">
	...
	s1, _ := term.NewURIRef("http://other.org/s1")
	o1, _ := term.NewURIRef("http://other.org/o1")
	p, _ := term.NewURIRef("http://example.org/p")
...
func TestSerializerMultipleRDFType(t *testing.T) {
	...
	g.Bind("ex", term.NewURIRefUnsafe("http://example.org/"))
	g.Add(s, namespace.RDF.Type, term.NewURIRefUnsafe("http://example.org/Person"))
	g.Add(s, namespace.RDF.Type, term.NewURIRefUnsafe("http://example.org/Agent"))
	g.Add(s, term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("Alice"))
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="s">
	...
	s, _ := term.NewURIRef("http://example.org/s")
	addr, _ := term.NewURIRef("http://example.org/address")
