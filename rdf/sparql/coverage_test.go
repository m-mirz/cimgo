...
func TestExtractSimpleBGPNonSimple(t *testing.T) {
	...
	result = extractSimpleBGP(&BGP{Triples: []Triple{{
		...
		Predicate:     "?p",
		Object:        "?o",
		PredicatePath: &paths.URIRefPath{URI: term.NewURIRefUnsafe("http://example.org/p")},
	}}})
	if result != nil {
...
func TestResolveTermRefInteger(t *testing.T) {
	...
	l, ok := result.(term.Literal)
	if !ok {
		t.Fatalf("expected Literal, got %T", result)
	}
	if l.Datatype() != term.XSDInteger {
...
func TestEvalUnaryUnknownOp(t *testing.T) {
	result := evalUnaryOp("%", term.NewLiteral(1))
	if result != nil {
...
func TestIsDecimalTrue(t *testing.T) {
	lit := term.NewLiteral("1.5", term.WithDatatype(term.XSDDecimal))
	if !isDecimal(lit) {
		t.Error("expected true")
	}
}
...
func TestIsDecimalFalseNonLiteral(t *testing.T) {
	u := term.NewURIRefUnsafe("http://example.org/x")
	if isDecimal(u) {
...
func TestTermValuesEqualOneNil(t *testing.T) {
	if termValuesEqual(nil, term.NewLiteral(1)) {
		t.Error("expected nil != non-nil")
	}
	if termValuesEqual(term.NewLiteral(1), nil) {
...
func TestContainsExistsLiteral(t *testing.T) {
	if containsExists(&LiteralExpr{Value: term.NewLiteral(1)}) {
...
func TestEvalExprWithGraphDefault(t *testing.T) {
	...
	g := makeSPARQLGraph(t)
	e := &LiteralExpr{Value: term.NewLiteral(42)}
...
func TestExtractTemplateFromPatternNonBGP(t *testing.T) {
	result := extractTemplateFromPattern(&FilterPattern{
		...
		Expr:    &LiteralExpr{Value: term.NewLiteral(true)},
	})
	if result != nil {
...
func TestEffectiveBooleanValueNonLiteral(t *testing.T) {
	// URIRef has EBV true
	if !effectiveBooleanValue(term.NewURIRefUnsafe("http://example.org/x")) {
...
func TestToFloat64NonLiteral(t *testing.T) {
	if toFloat64(term.NewURIRefUnsafe("http://example.org/x")) != 0 {
...
func TestStringResultWithDatatype(t *testing.T) {
	source := term.NewLiteral("x", term.WithDatatype(term.XSDInteger))
	result := stringResult("42", source)
	if result.Datatype() != term.XSDInteger {
		t.Errorf("expected xsd:integer, got %v", result.Datatype())
	}
}

func TestStringResultPlain(t *testing.T) {
	source := term.NewURIRefUnsafe("http://example.org/x")
	result := stringResult("hello", source)
	if result.Datatype() != term.XSDString {
...
func TestIsStringLiteralNonLiteral(t *testing.T) {
	if isStringLiteral(term.NewURIRefUnsafe("http://example.org/x")) {
		t.Error("expected false for URI")
	}
}
...
func TestUpdateParseError(t *testing.T) {
	ds := &Dataset{Default: graph.NewGraph()}
...
func TestParseDatePairInvalid(t *testing.T) {
	a := term.NewLiteral("not-a-date", term.WithDatatype(term.XSDDateTime))
	b := term.NewLiteral("not-a-date", term.WithDatatype(term.XSDDateTime))
...
func TestCompareTermValuesDate(t *testing.T) {
	a := term.NewLiteral("2024-01-01", term.WithDatatype(term.XSDDate))
	b := term.NewLiteral("2024-06-01", term.WithDatatype(term.XSDDate))
...
func TestResolvePatternTermNumericDouble(t *testing.T) {
	...
	l := result.(term.Literal)
	if l.Datatype() != term.XSDDouble {
...
func TestEvalGraphPatternSpecificGraph(t *testing.T) {
	g := graph.NewGraph()
	ng := graph.NewGraph()
	ex, _ := term.NewURIRef("http://example.org/x")
	p, _ := term.NewURIRef("http://example.org/p")
	ng.Add(ex, p, term.NewLiteral("inNamedGraph"))
...
func TestCollectExprVarsIRIAndLiteral(t *testing.T) {
	...
	vars = collectExprVars(&LiteralExpr{Value: term.NewLiteral(1)})
	if len(vars) > 0 {
...
func TestDropNamed(t *testing.T) {
	ds := &Dataset{
		...
		NamedGraphs: make(map[string]*graph.Graph),
	}
	ng := graph.NewGraph()
	ex1, _ := term.NewURIRef("http://example.org/x")
	p, _ := term.NewURIRef("http://example.org/p")
	ng.Add(ex1, p, term.NewLiteral("value"))
...
func TestClearAll(t *testing.T) {
	...
	ex1, _ := term.NewURIRef("http://example.org/x")
	p, _ := term.NewURIRef("http://example.org/p")
	ds.Default.Add(ex1, p, term.NewLiteral("value"))
	ng := graph.NewGraph()
	ng.Add(ex1, p, term.NewLiteral("ng-value"))
	ds.NamedGraphs["http://example.org/g1"] = ng
...
func TestCreateExistingGraph(t *testing.T) {
	ds := &Dataset{
		Default:     graph.NewGraph(),
		NamedGraphs: map[string]*graph.Graph{"http://example.org/g1": graph.NewGraph()},
	}
...
func TestClearDefault(t *testing.T) {
	...
	ex1, _ := term.NewURIRef("http://example.org/x")
	p, _ := term.NewURIRef("http://example.org/p")
	ds.Default.Add(ex1, p, term.NewLiteral("v"))
...
func TestDeleteWhereGraph(t *testing.T) {
	...
	ex1, _ := term.NewURIRef("http://example.org/x")
	p, _ := term.NewURIRef("http://example.org/p")
	ng.Add(ex1, p, term.NewLiteral("hello"))
	ds.NamedGraphs["http://example.org/g1"] = ng
...
func TestResultsEqualDifferentSizes(t *testing.T) {
	a := &Result{Type: "SELECT", Vars: []string{"x"}, Bindings: []map[string]term.Term{{"x": term.NewLiteral(1)}}}
	b := &Result{Type: "SELECT", Vars: []string{"x"}, Bindings: []map[string]term.Term{}}
	if ResultsEqual(a, b) {
...
func TestDecimalArithmetic(t *testing.T) {
	...
	l := r.Bindings[0]["result"].(term.Literal)
	if l.Datatype() != term.XSDDecimal {
...
func TestValidateTripleTermsFilterPattern(t *testing.T) {
	bgp := &BGP{Triples: []Triple{{Subject: "<http://a>", Predicate: "<http://p>", Object: "<http://o>"}}}
	fp := &FilterPattern{Pattern: bgp, Expr: &LiteralExpr{Value: term.NewLiteral("true", term.WithDatatype(term.NewURIRefUnsafe("http://www.w3.org/2001/XMLSchema#boolean")))}}
...
func TestValidateTripleTermsBindPattern(t *testing.T) {
	bgp := &BGP{Triples: []Triple{{Subject: "<http://a>", Predicate: "<http://p>", Object: "<http://o>"}}}
	bp := &BindPattern{Pattern: bgp, Expr: &LiteralExpr{Value: term.NewLiteral("1")}, Var: "x"}
...
func TestValidateTripleTermsValuesPattern(t *testing.T) {
	vp := &ValuesPattern{Vars: []string{"x"}, Values: [][]term.Term{{term.NewURIRefUnsafe("http://a")}}}
...
func TestValidateConstructWhereFilterDirect(t *testing.T) {
	...
	fp := &FilterPattern{Pattern: bgp, Expr: &LiteralExpr{Value: term.NewLiteral("true")}}
...
func TestEvalModifyWithGraphAndUsing(t *testing.T) {
	g := graph.NewGraph()
	ex := term.NewURIRefUnsafe
	g.Add(ex("http://example.org/s"), ex("http://example.org/p"), term.NewLiteral("val"))

	ng := graph.NewGraph()
	ng.Add(ex("http://example.org/s2"), ex("http://example.org/p"), term.NewLiteral("val2"))

	ds := &Dataset{
		Default:     g,
		NamedGraphs: map[string]*graph.Graph{"http://example.org/g1": ng},
	}
...
func TestEvalModifyWithUsingClauses(t *testing.T) {
	...
	ng := graph.NewGraph()
	ng.Add(ex("http://example.org/s"), ex("http://example.org/p"), term.NewLiteral("val"))
...
func TestEvalInsertDataBadPredicate(t *testing.T) {
	...
	g := graph.NewGraph()
	ds := &Dataset{Default: g, NamedGraphs: map[string]*graph.Graph{}}
...
func TestEvalGraphMgmtAddCopyMove(t *testing.T) {
	ex := term.NewURIRefUnsafe
	g := graph.NewGraph()
	g.Add(ex("http://example.org/s"), ex("http://example.org/p"), term.NewLiteral("default"))

	ng := graph.NewGraph()
	ng.Add(ex("http://example.org/s2"), ex("http://example.org/p"), term.NewLiteral("named"))
...
func TestBuildNegatedPathBothFwdAndInv(t *testing.T) {
	...
	fwd := []term.URIRef{term.NewURIRefUnsafe("http://example.org/a")}
	inv := []term.URIRef{term.NewURIRefUnsafe("http://example.org/b")}
...
func TestResultsEqualDifferentLengths(t *testing.T) {
	a := &Result{Type: "SELECT", Bindings: []map[string]term.Term{{"x": term.NewLiteral("a")}}}
	b := &Result{Type: "SELECT", Bindings: []map[string]term.Term{}}
	if ResultsEqual(a, b) {
...
func TestEvalClearSpecificGraph(t *testing.T) {
	...
	g := graph.NewGraph()
	ng := graph.NewGraph()
	ng.Add(ex("http://s"), ex("http://p"), term.NewLiteral("val"))
...
func TestContainsExistsInBinary(t *testing.T) {
	...
	binary := &BinaryExpr{Op: "&&", Left: &LiteralExpr{Value: term.NewLiteral("true")}, Right: exists}
...
func TestContainsExistsNone(t *testing.T) {
	expr := &BinaryExpr{Op: "+", Left: &VarExpr{Name: "x"}, Right: &LiteralExpr{Value: term.NewLiteral("1")}}
...
func TestValidateNoNestedAggregatesBinary(t *testing.T) {
	expr := &BinaryExpr{
		...
		Right: &LiteralExpr{Value: term.NewLiteral("1")},
	}
...
func TestUpdateDeleteInsertComplex(t *testing.T) {
	g := graph.NewGraph()
	ex := term.NewURIRefUnsafe
	g.Add(ex("http://example.org/s1"), ex("http://example.org/status"), term.NewLiteral("draft"))
	g.Add(ex("http://example.org/s2"), ex("http://example.org/status"), term.NewLiteral("published"))
...
func TestTermValuesEqualTripleTerms(t *testing.T) {
	s := term.NewURIRefUnsafe("http://s")
	p := term.NewURIRefUnsafe("http://p")
	o := term.NewURIRefUnsafe("http://o")
	tt1 := term.NewTripleTerm(s, p, o)
	tt2 := term.NewTripleTerm(s, p, o)
...
func TestTermValuesEqualDifferentTripleTerms(t *testing.T) {
	s1 := term.NewURIRefUnsafe("http://s1")
	s2 := term.NewURIRefUnsafe("http://s2")
	p := term.NewURIRefUnsafe("http://p")
	o := term.NewURIRefUnsafe("http://o")
	tt1 := term.NewTripleTerm(s1, p, o)
	tt2 := term.NewTripleTerm(s2, p, o)
	if termValuesEqual(tt1, tt2) {
...
func TestDeleteWhereNamedGraphVarCov(t *testing.T) {
	...
	ds := &Dataset{
		Default:     graph.NewGraph(),
		NamedGraphs: map[string]*graph.Graph{"http://example.org/g": ng},
	}
	err := Update(ds, `
		PREFIX ex: <http://example.org/>
...
func TestUpdateMultipleUsing(t *testing.T) {
	...
	g := graph.NewGraph()
	ng1 := graph.NewGraph()
	ng1.Add(ex("http://example.org/a"), ex("http://example.org/p"), term.NewLiteral("val1"))
	ng2 := graph.NewGraph()
	ng2.Add(ex("http://example.org/b"), ex("http://example.org/p"), term.NewLiteral("val2"))
...
func TestDropNamedGraphs(t *testing.T) {
	ex := term.NewURIRefUnsafe
	ng := graph.NewGraph()
	ng.Add(ex("http://s"), ex("http://p"), term.NewLiteral("v"))
	ds := &Dataset{
		Default:     graph.NewGraph(),
		NamedGraphs: map[string]*graph.Graph{"http://example.org/g": ng},
	}
...
func TestGraphRefAllDefaultCov(t *testing.T) {
	ex := term.NewURIRefUnsafe
	g := graph.NewGraph()
	g.Add(ex("http://s"), ex("http://p"), term.NewLiteral("v"))
	ds := &Dataset{Default: g, NamedGraphs: map[string]*graph.Graph{}}
	err := Update(ds, `CLEAR DEFAULT`)
	if err != nil {
		t.Fatal(err)
...
func TestConstructAnnotationsReifier(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		CONSTRUCT {
			ex:s ex:p "v" ~ ex:r1 .
...
func TestClearGraphSpecific(t *testing.T) {
	ds := makeUpdateDataset()
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
...
func TestNestedAggregateErrorEndToEnd(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("1", term.WithDatatype(term.XSDInteger)))
	_, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestValidateStringEscapesLongQuoteEndToEnd(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("multi\nline"))
...
func TestDeleteWhereWithGraphClause(t *testing.T) {
	ds := makeUpdateDataset()
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("1"))
	ng.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("2"))
	ds.NamedGraphs["http://example.org/g"] = ng
...
func TestDeleteWhereWithSimple(t *testing.T) {
	ds := makeUpdateDataset()
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("val"))
	ds.NamedGraphs["http://example.org/g"] = ng
...
func TestOrderByAscWithParens(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("3", term.WithDatatype(term.XSDInteger)))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("1", term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?o WHERE {
			?s ex:p ?o .
...
func TestGroupConcatSeparatorCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("a"))
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("b"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestContainsExistsBinaryExprCov(t *testing.T) {
	e := &BinaryExpr{
		...
		Right: &LiteralExpr{Value: term.NewLiteral(true)},
	}
	if !containsExists(e) {
...
func TestUnaryMinusCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("5", term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?neg WHERE {
			ex:s ex:p ?v .
...
func TestModifyWithUsingNamedCov(t *testing.T) {
	ds := makeUpdateDataset()
	ds.Default.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/x"), term.NewURIRefUnsafe("http://example.org/q"), term.NewLiteral("w"))
	ds.NamedGraphs["http://example.org/g"] = ng
	err := Update(ds, `
...
func TestModifyWithWithCov(t *testing.T) {
	ds := makeUpdateDataset()
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("old"))
	ds.NamedGraphs["http://example.org/g"] = ng
	err := Update(ds, `
		WITH <http://example.org/g>
		DELETE { <http://example.org/s> <http://example.org/p> ?o }
...
func TestExistsInBooleanExprCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/q"), term.NewLiteral("w"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?s WHERE {
			?s ex:p ?o .
...
func TestDatePartFromDateCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"),
		term.NewLiteral("2023-05-15", term.WithDatatype(term.NewURIRefUnsafe("http://www.w3.org/2001/XMLSchema#date"))))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestDateTimeWithoutTZ(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"),
		term.NewLiteral("2023-06-15T10:30:00", term.WithDatatype(term.NewURIRefUnsafe("http://www.w3.org/2001/XMLSchema#dateTime"))))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestSubQueryWithOrderByLimitCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("1", term.WithDatatype(term.XSDInteger)))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("2", term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?top WHERE {
...
func TestNegatedPathInverseOnlyCov(t *testing.T) {
	...
	s := term.NewURIRefUnsafe("http://example.org/s")
	o := term.NewURIRefUnsafe("http://example.org/o")
	g.Add(s, term.NewURIRefUnsafe("http://example.org/p1"), o)
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?s WHERE {
			ex:o !(^ex:excluded) ?s .
...
func TestHavingWithExpressionCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/type"), term.NewURIRefUnsafe("http://example.org/T1"))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/type"), term.NewURIRefUnsafe("http://example.org/T1"))
	g.Add(term.NewURIRefUnsafe("http://example.org/c"), term.NewURIRefUnsafe("http://example.org/type"), term.NewURIRefUnsafe("http://example.org/T2"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestNotInOperatorCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("d"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?o WHERE {
			ex:s ex:p ?o .
...
func TestSampleAggregateCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/type"), term.NewURIRefUnsafe("http://example.org/T"))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/type"), term.NewURIRefUnsafe("http://example.org/T"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestCountDistinctCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestCodepointEscapesInIRICov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/caf\u00E9"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
...
func TestRegexFunctionCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("Alice"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?n WHERE {
			ex:s ex:name ?n .
...
func TestReplaceFunctionCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("hello world"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestConcatFunctionCov(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("hello"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestTermValuesEqualNaN(t *testing.T) {
	...
	nan := term.NewLiteral("NaN", term.WithDatatype(term.XSDDouble))
...
func TestTermValuesEqualLangLiterals(t *testing.T) {
	a := term.NewLiteral("hello", term.WithLang("en"))
	b := term.NewLiteral("hello", term.WithLang("fr"))
...
func TestEvalUnaryNotOnURIRef(t *testing.T) {
	...
	uri := term.NewURIRefUnsafe("http://example.org/x")
	r := evalUnaryOp("!", uri)
	if r != nil {
...
func TestSubstrStartBeyondLength(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("hi"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestRegexInvalidPattern(t *testing.T) {
	r := evalFunc("REGEX", []Expr{
		&LiteralExpr{Value: term.NewLiteral("hello")},
		&LiteralExpr{Value: term.NewLiteral("[invalid")},
	}, nil, nil)
...
func TestReplaceNumericInput(t *testing.T) {
	...
	r := evalFunc("REPLACE", []Expr{
		&LiteralExpr{Value: term.NewLiteral(42, term.WithDatatype(term.XSDInteger))},
		&LiteralExpr{Value: term.NewLiteral("4")},
		&LiteralExpr{Value: term.NewLiteral("X")},
	}, nil, nil)
	if r != nil {
...
func TestReplaceNonLiteralInput(t *testing.T) {
	r := evalFunc("REPLACE", []Expr{
		&LiteralExpr{Value: term.NewURIRefUnsafe("http://example.org/x")},
		&LiteralExpr{Value: term.NewLiteral("x")},
		&LiteralExpr{Value: term.NewLiteral("y")},
	}, nil, nil)
	if r != nil {
...
func TestConcatWithNilArg(t *testing.T) {
	...
	r := evalFunc("CONCAT", []Expr{
		&LiteralExpr{Value: term.NewLiteral("hi")},
...
func TestTripleFuncNonSubject(t *testing.T) {
	...
	r := evalFunc("TRIPLE", []Expr{
		&LiteralExpr{Value: term.NewLiteral("lit")},
		&LiteralExpr{Value: term.NewURIRefUnsafe("http://example.org/p")},
		&LiteralExpr{Value: term.NewLiteral("obj")},
	}, nil, nil)
	if r != nil {
...
func TestTripleFuncNonPredicate(t *testing.T) {
	r := evalFunc("TRIPLE", []Expr{
		&LiteralExpr{Value: term.NewURIRefUnsafe("http://example.org/s")},
		&LiteralExpr{Value: term.NewLiteral("notURI")},
		&LiteralExpr{Value: term.NewLiteral("obj")},
	}, nil, nil)
	if r != nil {
...
func TestStrlangdirTypeError(t *testing.T) {
	...
	r := evalFunc("STRLANGDIR", []Expr{
		&LiteralExpr{Value: term.NewLiteral("hello", term.WithLang("en"))},
		&LiteralExpr{Value: term.NewLiteral("en")},
		&LiteralExpr{Value: term.NewLiteral("ltr")},
	}, nil, nil)
	if r != nil {
...
func TestResultsEqualBnodeMismatch(t *testing.T) {
	a := &Result{
		Vars:     []string{"x"},
		Bindings: []map[string]term.Term{{"x": term.NewBNode("a")}},
	}
	b := &Result{
		Vars:     []string{"x"},
		Bindings: []map[string]term.Term{{"x": term.NewBNode("b")}},
	}
...
func TestBGPWithPropertyPath(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewURIRefUnsafe("http://example.org/o"))
	tp := Triple{
		Subject:       "?s",
		Object:        "?o",
		PredicatePath: paths.URIRefPath{URI: term.NewURIRefUnsafe("http://example.org/p")},
	}
	result := evalBGP(g, []Triple{tp}, map[string]term.Term{}, nil)
	if len(result) == 0 {
...
func TestSumAggregateWithError(t *testing.T) {
	...
	group := []map[string]term.Term{{"x": nil}}
...
func TestAvgAggregateDecimal(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/v"), term.NewLiteral("1.5", term.WithDatatype(term.XSDDecimal)))
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/v"), term.NewLiteral("2.5", term.WithDatatype(term.XSDDecimal)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestBnodePropertyListInQuery(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("Alice"))
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/age"), term.NewLiteral(30, term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?name WHERE {
...
func TestGroupByExprAsVar(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/val"), term.NewLiteral(1, term.WithDatatype(term.XSDInteger)))
	g.Add(term.NewURIRefUnsafe("http://example.org/b"), term.NewURIRefUnsafe("http://example.org/val"), term.NewLiteral(2, term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestAPathWithModifier(t *testing.T) {
	...
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"), term.NewURIRefUnsafe("http://example.org/C"))
	r, err := Query(g, `SELECT ?o WHERE { <http://example.org/s> a ?o }`)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTransferGraphsViaUpdate(t *testing.T) {
	...
	ds.Default.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v"))
	ng := graph.NewGraph()
	ng.Add(term.NewURIRefUnsafe("http://example.org/s2"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("w"))
	ds.NamedGraphs["http://example.org/g"] = ng
...
func TestBinaryOpNonNumericEqual(t *testing.T) {
	...
	a := term.NewLiteral("hello")
	b := term.NewLiteral("hello")
	r := evalBinaryOp("=", a, b)
	if r == nil {
		t.Fatal("expected non-nil")
	}
...
func TestBnodePropertyListCommaSemicolon(t *testing.T) {
	...
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/name"), term.NewLiteral("A"))
	g.Add(term.NewURIRefUnsafe("http://example.org/a"), term.NewURIRefUnsafe("http://example.org/age"), term.NewLiteral(30, term.WithDatatype(term.XSDInteger)))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestAnnotationBlockCommaSemicolon(t *testing.T) {
	...
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v1"))
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/p"), term.NewLiteral("v2"))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
		SELECT ?v WHERE {
			ex:s ex:p ?v, "v2" .
...
func TestSumAggregateWithNilArg(t *testing.T) {
	...
	group := []map[string]term.Term{{"y": term.NewLiteral(1)}} // x not bound → nil
	r := evalAggregate(fe, group, nil)
	_ = r
}
...
func TestMinAggregateEmpty(t *testing.T) {
	...
	group := []map[string]term.Term{{"y": term.NewLiteral(1)}} // x not bound
	r := evalAggregate(fe, group, nil)
	_ = r
}
...
func TestMaxAggregateEmpty(t *testing.T) {
	...
	group := []map[string]term.Term{{"y": term.NewLiteral(1)}}
	r := evalAggregate(fe, group, nil)
	_ = r
}
...
func TestUnknownAggregateType(t *testing.T) {
	...
	group := []map[string]term.Term{{"x": term.NewLiteral(1)}}
	r := evalAggregate(fe, group, nil)
	if r != nil {
...
func TestSubstrNegativeStart(t *testing.T) {
	r := evalFunc("SUBSTR", []Expr{
		&LiteralExpr{Value: term.NewLiteral("hello")},
		&LiteralExpr{Value: term.NewLiteral(-1, term.WithDatatype(term.XSDInteger))},
	}, nil, nil)
	if r == nil {
...
func TestSubstrLengthExceedsString(t *testing.T) {
	r := evalFunc("SUBSTR", []Expr{
		&LiteralExpr{Value: term.NewLiteral("hi")},
		&LiteralExpr{Value: term.NewLiteral(1, term.WithDatatype(term.XSDInteger))},
		&LiteralExpr{Value: term.NewLiteral(100, term.WithDatatype(term.XSDInteger))},
	}, nil, nil)
	if r == nil {
		t.Error("expected non-nil")
	}
...
func TestXsdBooleanCastFromNonLiteral(t *testing.T) {
	r := evalFunc("XSD:BOOLEAN", []Expr{
		&LiteralExpr{Value: term.NewBNode("b1")},
	}, nil, nil)
	if r != nil {
...
func TestXsdBooleanCastFromNumeric(t *testing.T) {
	r := evalFunc("XSD:BOOLEAN", []Expr{
		&LiteralExpr{Value: term.NewLiteral("bad", term.WithDatatype(term.XSDDouble))},
	}, nil, nil)
	_ = r
}
...
func TestTimezoneOffsetNonZero(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/dt"),
		term.NewLiteral("2023-01-01T10:00:00+05:30", term.WithDatatype(term.NewURIRefUnsafe("http://www.w3.org/2001/XMLSchema#dateTime"))))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestSecondsWithFraction(t *testing.T) {
	g := graph.NewGraph()
	g.Add(term.NewURIRefUnsafe("http://example.org/s"), term.NewURIRefUnsafe("http://example.org/dt"),
		term.NewLiteral("2023-01-01T10:00:05.123Z", term.WithDatatype(term.NewURIRefUnsafe("http://www.w3.org/2001/XMLSchema#dateTime"))))
	r, err := Query(g, `
		PREFIX ex: <http://example.org/>
...
func TestCompareTermValuesNils(t *testing.T) {
	...
	// a nil, b non-nil
	if compareTermValues(nil, term.NewLiteral("x")) >= 0 {
		t.Error("expected < 0 for nil,non-nil")
	}
	// a non-nil, b nil
	if compareTermValues(term.NewLiteral("x"), nil) <= 0 {
...
func TestCompareTermValuesNaN(t *testing.T) {
	nan := term.NewLiteral("NaN", term.WithDatatype(term.XSDDouble))
	num := term.NewLiteral("1.0", term.WithDatatype(term.XSDDouble))
...
func TestXsdIntegerCastNaN(t *testing.T) {
	r := evalFunc("XSD:INTEGER", []Expr{
		&LiteralExpr{Value: term.NewLiteral("NaN", term.WithDatatype(term.XSDDouble))},
	}, nil, nil)
	if r != nil {
...
func TestSumAggregateHasError(t *testing.T) {
	...
	fe := &FuncExpr{Name: "SUM", Args: []Expr{&VarExpr{Name: "x"}}}
	group := []map[string]term.Term{
		{"x": term.NewLiteral("abc")},
		{"x": term.NewLiteral(1, term.WithDatatype(term.XSDInteger))},
	}
	r := evalAggregate(fe, group, nil)
