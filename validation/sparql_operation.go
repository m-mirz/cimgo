...
func CheckMeasurementTerminalRequiredCases(dataset *cimgostructs.CIMElementList) []Violation {
	...
	for id, obj := range dataset.Elements {
		var mType string
		var psrRef *struct { MRID string `xml:"resource,attr"` }
		var termRef *struct { MRID string `xml:"resource,attr"` }
		var class string
