...
func dependentOnProfiles(m *cimstructs.Model, dataset *cimstructs.CIMDataset) []string {
...
func datasetHasProfile(dataset *cimstructs.CIMDataset, prof string) bool {
...
func ValidateProf10HeaderRules(dataset *cimstructs.CIMDataset) []Violation {
...
func checkProf10Model(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	switch profileURI(m) {
	case profEQ:
...
func checkProf10EQ(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
...
func checkProf10DY(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
...
func checkProf10DL(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
...
func checkProf10SC(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
...
func checkProf10OP(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
...
// External deps pass vacuously; each resolved dep must be in the allowed set.
func checkProf10GL(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
...
func checkProf10SV(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
...
func checkProf10TP(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
...
func checkProf10SSH(id string, m *cimstructs.Model, dataset *cimstructs.CIMDataset) []Violation {
	deps := dependentOnProfiles(m, dataset)
	if len(deps) == 0 {
